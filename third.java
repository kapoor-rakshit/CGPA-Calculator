...
public class third extends Activity {
    ...
    private String[] arrText =
            new String[]{"Maths-II","ASN","EDC","Digital Elect."
                    ,"CSS","OOPS","OOPS Lab","ASN Lab","EDC Lab","DE Lab","SGPA of SEM-I","SGPA of SEM-II"};
    private int[] regc=new int[]{4,4,4,4,4,3,1,1,1,1};                        //change according to semester
    ...
    int flg=0;
    double obtc=0;
    double totalc=27;                                                          //change according to semester
    double fobtc=0;
    double ftotalc=20.00+26.00+27;                                               //change according to semester
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                fobtc=0;
                obtc=0;
                for(int i=0;i<arrText.length-2;i++)                           //change according to semester
                {
...
for(;temp<arrTemp.length;temp++)
{
    ...
    {flg=1;break;}
                ...
                if(flg==0)
                fobtc=(Double.parseDouble(arrTemp[i++])*20+obtc+Double.parseDouble(arrTemp[i])*26);       //change according to semester
                else
                fobtc=0;
                ...
                Toast.makeText(third.this,"Your SGPA is : "+anss+"\nYour CGPA is : "+ansc,Toast.LENGTH_LONG).show();
            }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = third.this.getLayoutInflater();
