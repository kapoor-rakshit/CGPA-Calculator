...
public class second extends Activity {
    ...
    private String[] arrText =
            new String[]{"Maths-I","Chemistry","Elem. of Mech. Engg.","English"
                    ,"Env. Sci.","Basic Elect.","Manufacturing Procs.","English Lab","Chemistry Lab","Basic Elect. Lab","SGPA of SEM-I"};
    private int[] regc=new int[]{4,4,4,3,2,2,3,2,1,1};
    ...
    int flg=0;
    double obtc=0;
    double totalc=26;                                                          //change according to semester
double fobtc=0;
    double ftotalc=20.00+26.00;                                               //change according to semester
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                obtc=0;
                flg=0;
                for(int i=0;i<arrText.length-1;i++)                           //change according to semester
                {
...
if(flg==0) {fobtc+=(Double.parseDouble(arrTemp[i])*20+obtc);  }     //change according to semester
else {fobtc=0;}
                ...
                Toast.makeText(second.this,"Your SGPA is : "+anss+"\nYour CGPA is : "+ansc,Toast.LENGTH_LONG).show();
            }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = second.this.getLayoutInflater();
