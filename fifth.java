...
public class fifth extends Activity {
    ...
    private String[] arrText =
            new String[]{"Microprocs.","VLSI","HR Mngmt.","Material Sci."
                    ,"Control Engg.","OS","MProcs. Lab","MatLab Lab","OS Lab","Industrial Training","SGPA of SEM-I","SGPA of SEM-II","SGPA of SEM-III",
                    "SGPA of SEM-IV"};
    private int[] regc=new int[]{4,4,3,3,3,3,1,1,1,2};                        //change according to semester
    ...
    double fobtc=0;
    double ftotalc=20.00+26.00+27+25+25;                                               //change according to semester
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                fobtc=0;
                obtc=0;
                for(int i=0;i<arrText.length-4;i++)                           //change according to semester
                {
...
if(flg==0) fobtc=(Double.parseDouble(arrTemp[i++])*20+obtc+Double.parseDouble(arrTemp[i++])*26+
                        Double.parseDouble(arrTemp[i++])*27+Double.parseDouble(arrTemp[i])*25);       //change according to semester
else fobtc=0;
                ...
                ansc="  ---";
                Toast.makeText(fifth.this,"Your SGPA is : "+anss+"\nYour CGPA is : "+ansc,Toast.LENGTH_LONG).show();
            }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = fifth.this.getLayoutInflater();
