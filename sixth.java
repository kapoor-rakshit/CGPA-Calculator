...
public class sixth extends Activity {
    ...
    private String[] arrText =
            new String[]{"DSD","DCS","DSP","ADV. MPMC"
                    ,"Economics","DSD Lab","DCS Lab","DSP Lab","ADV. MPMC Lab","SGPA of SEM-I","SGPA of SEM-II","SGPA of SEM-III",
                    "SGPA of SEM-IV","SGPA of SEM-V"};
    private int[] regc=new int[]{4,4,4,4,3,1,1,1,1};                        //change according to semester
    ...
    private String ansc="";
    double obtc=0;
    double totalc=23;                                                          //change according to semester
    double fobtc=0;
    double ftotalc=20.00+26.00+27+25+25+23;                                               //change according to semester
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                fobtc=0;
                obtc=0;
                for(int i=0;i<arrText.length-5;i++)                           //change according to semester
                {
                ...
                fobtc=(Double.parseDouble(arrTemp[i++])*20+obtc+Double.parseDouble(arrTemp[i++])*26+
                        ...
                        Double.parseDouble(arrTemp[i])*25);       //change according to semester
                else fobtc=0;
                ...
                ansc="  ---";
                Toast.makeText(sixth.this,"Your SGPA is : "+anss+"\nYour CGPA is : "+ansc,Toast.LENGTH_LONG).show();
            }
    ...
    private class MyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                LayoutInflater inflater = sixth.this.getLayoutInflater();
